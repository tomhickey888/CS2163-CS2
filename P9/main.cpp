//Hickey, Thomas    Matzen    Spring 2014    Program 9
//Overview: A program to simulate a slot machine using an array of structs for the wheels
...
int main()
{
  // Array to store slot wheel structs
  ...
  // Function call to initialize the wheels
  initializeSlot(slotWheels);
